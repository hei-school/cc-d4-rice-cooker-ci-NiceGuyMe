public class RiceCooker {
    ...
    public void addWater(int amount) {
        waterLevel += amount;
        System.out.println("Added " + amount + " cup(s) of water. Current water level: " + waterLevel + " cups.");
    }

    public void addRice(int amount) {
        riceAmount += amount;
        System.out.println("Added " + amount + " cup(s) of rice. Current rice amount: " + riceAmount + " cups.");
    }
